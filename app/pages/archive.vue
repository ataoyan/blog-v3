...
import { getCategoryIcon, getTagIcon } from '~/composables/useArticle'
...
const selectTag = (t: string | undefined) => {
	tag.value = t
...
<div class="archive-page">
	<!-- 筛选器组 -->
	<div class="filter-group" v-if="(categories && categories.length > 1) || (tags && tags.length > 0)">
		<!-- 分类筛选 -->
		<div class="category-dropdown" v-if="categories && categories.length > 1" ref="categoryDropdownRef">
			<div 
			...
			<Transition name="dropdown">
				...
				>
					...
					<div 
						:key="undefined" 
						:class="['dropdown-item', { active: !category, selected: !category }]"
					...
					<div 
						...
						:key="cat" 
						:class="['dropdown-item', { active: category === cat, selected: category === cat }]"
		...
		<!-- 标签筛选 -->
		<div class="category-dropdown" v-if="tags && tags.length > 0" ref="tagDropdownRef">
			<div 
				class="dropdown-trigger"
			...
			<Transition name="dropdown">
				...
				>
					...
					<div 
						:key="undefined" 
						:class="['dropdown-item', { active: !tag, selected: !tag }]"
					...
					<div 
						v-for="t in tags" 
						:key="t" 
						:class="['dropdown-item', { active: tag === t, selected: tag === t }]"
						@click="selectTag(t)"
					>
						<div class="category-content">
							<Icon 
	...
	<div class="archive-groups">
		<section
			...
			:key="group.year"
			:class="['archive-group', { expanded: isYearExpanded(group.year) }]"
		>
			<!-- 年份标题栏 -->
